...
{
    //创建地图实例
    var map = new .Map("map_container");
    //设置中心点坐标
    var point = new BMap.Point(119.3604359887837, 32.11956603949539);
    //地图初始化，同时设置地图展示级别
          ...
          .then((response) => {
            if(response.data.status=="200")
            {
                ...
                $.each(obj, function (n, value) {
                    ...
                    // // // 创建小车图标
                    // var myIcon = new BMapGL.Icon("https://img2.baidu.com/it/u=2155478205,160126204&fm=26&fmt=auto", new BMapGL.Size(52, 26));
                    // // 创建Marker标注，使用小车图标
            ...
            .then((response) => {
                if(response.data.status=="200")
                {
                    ...
                    $.each(obj, function (n, value) {
                        ...
                        var marker = new BMap.Marker(new BMap.Point(info2Community[n].lng,info2Community[n].lat));  // 创建标注
            ...
            .then((response) => {
                if(response.data.status=="200")
                {
                    ...
                    $.each(obj, function (n, value) {
                        ...
                        var marker = new BMap.Marker(new BMap.Point(info2Trip[n].lng,info2Trip[n].lat));  // 创建标注
